...
const REQUIRED = ['situation', 'timing', 'firstName', 'lastName', 'phone', 'email', 'website', 'pageUrl', 'treatment', 'fbclid', 'utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term'];
...
else ok(`all 15 contract fields posted (treatment="${new URLSearchParams(posted.body).get('treatment')}")`);
